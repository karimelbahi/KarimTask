...
import com.example.TentwentAssignment.databinding.RowFilteredMovieLayoutBinding
...
class SearchMovieAdapter(
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        val binding = RowFilteredMovieLayoutBinding.inflate(LayoutInflater.from(context), viewGroup, false)
    ...
    inner class ViewHolder(val binding: RowFilteredMovieLayoutBinding) : RecyclerView.ViewHolder(binding.root) {
